      ...
      <div className="relative z-10 h-full flex items-center justify-center p-4 sm:p-6 lg:p-8 animate-page-enter overflow-auto">
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center my-auto">
          ...
          <div 
            ...
            } backdrop-blur-xl border rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-12 relative overflow-hidden`}
            style={{ animation: 'slideInLeft 0.5s cubic-bezier(0.16, 1, 0.3, 1)' }}
          >
          ...
          <div className="hidden lg:block space-y-6">
            ...
            <div 
              className={`bg-gradient-to-br ${
                theme === 'light'
                  ? 'from-white/90 via-white/85 to-white/90 border-amber-500/40 shadow-amber-500/20'
                  : 'from-gray-900/80 via-gray-900/70 to-gray-900/80 border-yellow-500/30 shadow-yellow-500/10'
              } backdrop-blur-xl border rounded-3xl shadow-2xl p-8 relative overflow-hidden group`}
              style={{ animation: 'slideInRight 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.1s both' }}
            >
              {/* Glow effect */}
            ...
            {features.map((feature, index) => (
              <div
                ...
                } backdrop-blur-xl border rounded-2xl p-6 transition-all duration-500 group cursor-default relative overflow-hidden`}
                onMouseEnter={() => setHoveredFeature(index)}
                onMouseLeave={() => setHoveredFeature(null)}
                style={{ 
                  animation: `slideInRight 0.5s cubic-bezier(0.16, 1, 0.3, 1) ${parseFloat(feature.delay) + 0.15}s both`,
              ...
              >
                ...
                <div 
                  ...
                  style={{
                    background: 'linear-gradient(90deg, transparent, rgba(251, 191, 36, 0.1), transparent)',
                    animation: hoveredFeature === index ? 'shine 1.5s ease-in-out infinite' : 'none',
                  }}
                />
